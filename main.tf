...
resource "aws_subnet" "database" {
  ...
  availability_zone               = length(regexall("^[a-z]{2}-", element(var.db_azs, count.index))) > 0 ? element(var.db_azs, count.index) : null
  availability_zone_id            = length(regexall("^[a-z]{2}-", element(var.db_azs, count.index))) == 0 ? element(var.db_azs, count.index) : null
  ...
  tags = merge(
    {
      "Name" = format(
        ...
        var.name,
        element(var.db_azs, count.index),
      )
    },
    var.tags,
...
resource "aws_subnet" "redshift" {
  ...
  availability_zone               = length(regexall("^[a-z]{2}-", element(var.rs_azs, count.index))) > 0 ? element(var.rs_azs, count.index) : null
  availability_zone_id            = length(regexall("^[a-z]{2}-", element(var.rs_azs, count.index))) == 0 ? element(var.rs_azs, count.index) : null
  ...
  tags = merge(
    {
      "Name" = format(
        ...
        var.name,
        element(var.rs_azs, count.index),
      )
    },
    var.tags,
...
resource "aws_subnet" "elasticache" {
  ...
  availability_zone               = length(regexall("^[a-z]{2}-", element(var.ec_azs, count.index))) > 0 ? element(var.ec_azs, count.index) : null
  availability_zone_id            = length(regexall("^[a-z]{2}-", element(var.ec_azs, count.index))) == 0 ? element(var.ec_azs, count.index) : null
  ...
  tags = merge(
    {
      "Name" = format(
        ...
        var.name,
        element(var.ec_azs, count.index),
      )
    },
    var.tags,
